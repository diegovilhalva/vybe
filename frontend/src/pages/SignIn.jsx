        ...
        <div className='w-full h-screen bg-gradient-to-b from-black to-gray-900 flex flex-col justify-center items-center'>
            <div className='w-[90%] lg:max-w-[60%] h-[600px] bg-white rounded-2xl flex justify-center items-center overflow-hidden border-2 border-[#1a1f23]'>
                <div className='w-full lg:w-[50%] h-full bg-white flex flex-col items-center p-[10px] gap-[20px] justify-center'>
                    ...
                    <button className='w-[70%] px-[20px] py-[10px] bg-black text-white font-semibold h-[50px] cursor-pointer rounded-2xl mt-[30px]'>Entrar</button>
                    <p className='cursor-pointer text-gray-800' onClick={() => navigate('/signin')}>Ainda não possui uma conta ? <span className='border-b-2 border-b-black pb-[3px] text-black'>Registre-se</span></p>
